...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var x=Function.prototype.call;F=M?x.bind(x):function(){return x.apply(x,arguments)};var P={}.propertyIsEnumerable,T=Object.getOwnPropertyDescriptor;o=T&&!P.call({1:2},1)?function(e){var t=T(this,e);return!!t&&t.enumerable}:P;var I={};I=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var q={},D={},H={},N=Function.prototype,A=N.call,C=M&&N.bind.bind(A,A),R={},W=(H=M?C:function(e){return function(){return A.apply(e,arguments)}})({}.toString),z=H("".slice);R=function(e){return z(W(e),8,-1)};var U=Object,G=H("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
eM=function(e){return ex(B(e))};var eP=H({}.hasOwnProperty);// `HasOwnProperty` abstract operation
// https://tc39.es/ecma262/#sec-hasownproperty
// eslint-disable-next-line es/no-object-hasown -- safe
eF=Object.hasOwn||function(e,t){return eP(eM(e),t)};var eT={},eI=0,eq=Math.random(),eD=H(1..toString);eT=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eD(++eI+eq,36)};var eH=O.Symbol,eN=eE("wks"),eA=ea?eH.for||eH:eH&&eH.withoutSetter||eT,eC=TypeError,eR=(eF(eN,e="toPrimitive")||(eN[e]=es&&eF(eH,e)?eH[e]:eA("Symbol."+e)),eN[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
V=function(e,t){if(!K(e)||en(e))return e;var r,n=eg(e,eR);if(n){if(void 0===t&&(t="default"),r=F(n,e,t),!K(r)||en(r))return r;throw new eC("Can't convert object to primitive value")}return void 0===t&&(t="number"),ew(e,t)},// `ToPropertyKey` abstract operation
...
indexOf:tD(!1)}.indexOf,tN=H([].push);tO=function(e,t){var r,n=q(e),i=0,o=[];for(r in n)!eF(ta,r)&&eF(n,r)&&tN(o,r);// Don't enum bug & hidden keys
for(;t.length>i;)eF(n,r=t[i++])&&(~tH(o,r)||tN(o,r));return o};var tA=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tO(e,tA)},f=Object.getOwnPropertySymbols;var tC=H([].concat);// all object keys, includes non-enumerable and symbols
...
if("Function"===R(e))return H(e)})(t0.bind);// optional / simple context binding
tZ=function(e,t){return em(e),void 0===t?e:M?t1(e,t):function(){return e.apply(t,arguments)}};var t2={};t2=ei("document","documentElement");var t3={};t3=H([].slice);var t4={},t7=TypeError;t4=function(e,t){if(e<t)throw new t7("Not enough arguments");return e};var t8={};// eslint-disable-next-line redos/no-vulnerable -- safe
t8=/(?:ipad|iphone|ipod).*applewebkit/i.test(eu);var t9={};t9="process"===R(O.process);var t6=O.setImmediate,t5=O.clearImmediate,re=O.process,rt=O.Dispatch,rr=O.Function,rn=O.MessageChannel,ri=O.String,ro=0,ra={},rs="onreadystatechange";L(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
O.postMessage(ri(e),h.protocol+"//"+h.host)};t6&&t5||(t6=function(e){t4(arguments.length,1);var t=X(e)?e:rr(e),r=t3(arguments,1);return ra[++ro]=function(){tQ(t,void 0,r)},v(ro),ro},t5=function(e){delete ra[e]},t9?v=function(e){re.nextTick(ru(e))}:rt&&rt.now?v=function(e){rt.now(ru(e))}:rn&&!t8?(m=(g=new rn).port2,g.port1.onmessage=rl,v=tZ(m.postMessage,m)):O.addEventListener&&X(O.postMessage)&&!O.importScripts&&h&&"file:"!==h.protocol&&!L(rd)?(v=rd,O.addEventListener("message",rl,!1)):v=rs in ez("script")?function(e){t2.appendChild(ez("script"))[rs]=function(){t2.removeChild(this),rc(e)}}:function(e){setTimeout(ru(e),0)});var rp=(tY={set:t6,clear:t5}).clear;// `clearImmediate` method
...
},y=Fraction;class rq extends rI{_parentElement=document.querySelector(".recipe");_errorMessage="We could not find that recipe. Please try another one!";_message="";// funzione col subscribe
addHandlerRender(e){// EventListener multipli
["hashchange","load"].forEach(t=>window.addEventListener(t,e));// window.addEventListener('hashchange', showRecipe);
// window.addEventListener('load', showRecipe);
}addHandlerUpdateServings(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--update-servings");if(!r)return;let n=+r.dataset.updateTo;// const { updateTo } = +btn.dataset;
// Non si può fare il destructirung perchè convertiamo in numero quindi non è più uguale, andrebbe convertito qui sotto e lasciato normale durante il destructuring
n>0&&e(n)})}addHandlerAddBookmark(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--bookmark");r&&e()})}_generateMarkup(){return`
    ...
    `}}var rD=new rq;class rH{_parentEl=document.querySelector(".search");getQuery(){let e=this._parentEl.querySelector(".search__field").value;return this._clearInput(),e}_clearInput(){this._parentEl.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEl.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rN=new rH,rA=new class extends rI{_parentElement="";_generateMarkup(){let e=window.location.hash.slice(1);return`
    <li class="preview">
  ...
  `}};class rC extends rI{_parentElement=document.querySelector(".results");_errorMessage="No recipies found for your query! Please try again ;)";_message="";_generateMarkup(){// console.log(this._data);
return this._data.map(e=>rA.render(e,!1)).join("")}}var rR=new rC;class rW extends rI{_parentElement=document.querySelector(".pagination");addHandlerClick(e){this._parentElement.addEventListener("click",function(t){let r=t.target.closest(".btn--inline");if(!r)return;let n=+r.dataset.goto;// console.log(goToPage);
e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(// console.log(numPages);
...
1===e&&t>1?`
    ...
    `:"")}}var rz=new rW;class rU extends rI{_parentElement=document.querySelector(".bookmarks__list");_errorMessage="No bookmarks yet. Find a nice recipe and bookmark it ;)";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){// console.log(this._data);
return this._data.map(e=>rA.render(e,!1)).join("")}}var rG=new rU;class rB extends rI{_parentElement=document.querySelector(".upload");_message="Recipe was successfully uploaded :)";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}addHandlerUpload(e){this._parentElement.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rJ=new rB;// if (module.hot) {
//   module.hot.accept();
// }
const rY=async function(){try{let e=window.location.hash.slice(1);// console.log(id);
// console.log(window.location);
if(!e)return;// Guard
rD.renderSpinner(),rR.update(rj()),rG.update(rE.bookmarks),// 2) Loading Recipe
await rO(e),rD.render(rE.recipe)}catch(e){rD.renderError()}},rQ=async function(){try{rR.renderSpinner();// 1) Get search query
let e=rN.getQuery();if(!e)return;// 2) Load search results
await r$(e),rR.render(rj(1)),rz.render(rE.search)}catch(e){console.log(e)}},rV=async function(e){// console.log(newRecipe);
try{rJ.renderSpinner(),// Upload the new recipe
await rP(e),console.log(rE.recipe),rD.render(rE.recipe),rJ.renderMessage(),rG.render(rE.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${rE.recipe.id}`),// Close form window
setTimeout(function(){rJ.toggleWindow()},2500)}catch(e){console.error("\uD83E\uDDE8\uD83E\uDDE8\uD83E\uDDE8",e),rJ.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rE.bookmarks)}),rD.addHandlerRender(rY),rD.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
rL(e),rD.update(rE.recipe)}),rD.addHandlerAddBookmark(function(){rE.recipe.bookmarked?rE.recipe.bookmarked&&rx(rE.recipe.id):rM(rE.recipe),rD.update(rE.recipe),rG.render(rE.bookmarks)}),rN.addHandlerSearch(rQ),rz.addHandlerClick(function(e){rR.render(rj(e)),rz.render(rE.search)}),rJ.addHandlerUpload(rV);//# sourceMappingURL=index.684481ba.js.map

//# sourceMappingURL=index.684481ba.js.map
